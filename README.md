...
pixi add cvat-sdk cvat-sdk-masks cvat-sdk-pytorch
# for installing globally
pixi global install cvat-sdk cvat-sdk-masks cvat-sdk-pytorch
```
...
It is possible to list all of the versions of `cvat-sdk` available on your platform:
...
```
pixi search cvat-sdk --channel conda-forge
```
